import pool from '../utils/connection'; // Suponiendo que pool es tu conexión a la base de datos.
...
class UsuarioModelo {
  public async getByEmail(email: string) {
    try {
      ...
      return user.length > 0 ? user[0] : null; // Si no existe el usuario, retornamos null
    } catch (error) {
